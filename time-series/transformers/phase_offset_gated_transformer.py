...
from time_series.models.fan_layers import FANPhaseOffsetLayerGated


class PhaseOffsetGatedTransformerEncoderLayer(nn.Module):
    def __init__(
        self,
        d_model: int,
        nhead: int,
        ...
        self.fan = FANPhaseOffsetLayerGated(d_model, fan_dim)
...
@register_model('PhaseOffsetGatedTransformerForecaster')
class PhaseOffsetGatedTransformerForecaster(nn.Module):
    def __init__(
        self,
        input_dim: int = 1,
        d_model: int = 128,
        ...
        for i in range(num_layers):
            layer = PhaseOffsetGatedTransformerEncoderLayer(
                d_model=d_model,
                nhead=nhead,
                fan_dim=fan_dim,
                dropout=dropout
