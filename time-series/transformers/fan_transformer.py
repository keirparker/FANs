...
from time_series.models.fan_layers import FANLayer, FANLayerGated


class FANTransformerEncoderLayer(nn.Module):
    def __init__(
        self,
        d_model: int,
        nhead: int,
        ...
        self.fan = FANLayer(d_model, fan_dim)
...
class FANTransformerForecaster(nn.Module):
    def __init__(
        ...
        for i in range(num_layers):
            layer = FANTransformerEncoderLayer(
                d_model=d_model,
                nhead=nhead,
                fan_dim=fan_dim,
                dropout=dropout
